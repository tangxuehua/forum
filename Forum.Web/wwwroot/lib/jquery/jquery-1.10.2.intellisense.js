...
intellisense.annotate(jQuery.fn, {
  ...
  'clone': function() {
    ...
    /// <signature>
    ///   <summary>Create a deep copy of the set of matched elements.</summary>
    ///   <param name="withDataAndEvents" type="Boolean">A Boolean indicating whether event handlers and data should be copied along with the elements. The default value is false. *In jQuery 1.5.6 the default value was incorrectly true; it was changed back to false in 1.5.6 and up.</param>
