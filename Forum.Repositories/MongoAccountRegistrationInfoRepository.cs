...
{
    public class MongoAccountRegistrationInfoRepository : IAccountRegistrationInfoRepository
    {
        ...
        public MongoAccountRegistrationInfoRepository(string connectionString, string accountCollectionName)
        {
